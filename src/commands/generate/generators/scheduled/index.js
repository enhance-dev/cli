      ...
      examples: [
        {
          ...
          example: 'npx enhance gen scheduled --name my-task --rate "1 day"',
        },
        {
          name: 'Create a new scheduled event that runs every 15 minutes',
          example: 'npx enhance gen scheduled --name my-task --rate "15 minutes"',
        },
        {
          name: 'Create a new scheduled event that runs at 10:15 AM (UTC) every day',
          example: 'npx enhance gen scheduled --name my-task --cron "15 10 * * ? *"',
        },
        {
